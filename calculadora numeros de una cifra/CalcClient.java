...
while(x==1)
//Esta calculadora es para numeros de una unidad es decir del 0 a 9; por ejemplo +95 es: 9+5, /95 es: 9/5
{

System.out.println("Enter the string (First the operator and then two numbers):");
abc=br.readLine();
